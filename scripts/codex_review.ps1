...
$pl += ""
$pl += "CRITICAL: All the evidence you need is already in this prompt:"
$pl += "- The Current Task section below contains the spec and DoD items."
$pl += "- The Git Diff section below shows exactly what code changed."
$pl += "- The Validation Report section below has independently-run gate results."
$pl += "- The Worker Report section below has the implementer's account."
$pl += ""
$pl += "You may use codegraph and shell reads as SUPPLEMENTAL tools for extra"
$pl += "confidence, but they are NOT required. If codegraph is unavailable or"
$pl += "shell reads are blocked, review based on the prompt evidence above."
$pl += "Do NOT return NEED_HUMAN just because a supplemental tool is unavailable."
$pl += ""
...
$pl += "3. Cite file:line references from the diff and prompt content."
...
$pl += "8. If you cannot determine correctness from the SPEC (not from tool unavailability), verdict = NEED_HUMAN."
